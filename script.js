...
const searchFunc = function (e) {
  ...
  let user = inputBox.value.toLowerCase();

  let userURL = `${requestURL}${user}`;
    ...
    if (xhr.readyState == 4 && xhr.status == 200) {
      ...
      const addCard = `<div class="card">
        <div class="top-section">
          ...
          <img class="profile-photo" src="${avatar_url}" alt="" srcset="">
        </div>
        <div class="bottom-section">
          <span class="title">${name || user}</span>
          <div class="row row1">
            <div class="item">
              <span class="big-text">${public_repos}</span>
              <span class="regular-text">Repositories</span>
            </div>
            <div class="item">
            ...
            <div class="item">
              ...
              <span class="regular-text">Followings</span>
            </div>
          </div>
        </div>
      </div>`;
      cardContainer.innerHTML = addCard;
    }
  };
  xhr.send();
};
